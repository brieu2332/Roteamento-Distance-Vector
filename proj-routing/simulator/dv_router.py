"""
Your awesome Distance Vector router for Computer Networking

This work is based on CS 168 at University of California, Berkeley.
...
class DVRouter(DVRouterBase):
    ...
    def handle_data_packet(self, packet, in_port):
        ...
        if distan in self.table:
            route_entry = self.table[distan]
